from models import GradientDescentParams, GradientDescentResult, MiniBatchGradientDescentParams, MiniBatchGradientDescentResult
...
def gradient_descent(params: GradientDescentParams) -> GradientDescentResult:
  learning_rate, batch_size, weights, dataset, real_values = astuple(params)
  ...
  return GradientDescentResult(updated_weights=updated_weights, batch_results=batch_results)
