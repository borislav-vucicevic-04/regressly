...
class HtmlTemplates:
  ...
  GRADIENT_DESCENT_STEPS: str = """  
    ...
    <body>
      ...
      <h2>Dataset</h2>
      $dataset_table
      <h2>Updated weights formula and reuslt</h2>
      <div class="formula-box">
        <p>w<sub>i</sub> ← w<sub>i</sub> + α • Σ δ<sub>i</sub> • x<sub>i</sub> </p>
      </div>
      <p>α = $learning_rate </p>
      $updating_each_weight
      <div class="formula-box">
        <p>Updated weights: w = ($updated weights) </p>
      </div>
    </body>
    </html>
    """